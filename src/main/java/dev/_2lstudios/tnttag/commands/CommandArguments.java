...
import dev._2lstudios.tnttag.players.OfflinePlayer;
import dev._2lstudios.tnttag.utils.BukkitUtils;
...
public class CommandArguments {
    ...
    public CommandArguments(TNTTag plugin, Argument[] requiredArguments) {
        this.plugin = plugin;
    ...
    public TNTPlayer getPlayer(int index) {
        if (!this.hasIndex(index))
            return null;
        return (TNTPlayer) this.arguments.get(index);
    }
